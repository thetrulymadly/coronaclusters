...
<meta name="image" content="{{ asset('images/logo-sm.png') }}">
...
<meta itemtype="image" content="{{ asset('images/logo-sm.png') }}">
...
<meta name="msapplication-TileImage" content="{{ asset('corona/mstile-144x144.png') }}">

<link rel="manifest" href="{{ asset('corona/manifest.json') }}">
