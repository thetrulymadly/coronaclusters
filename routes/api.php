...
Route::group(['prefix' => 'geo', 'namespace' => 'Geo'], function () {
    Route::get('state/search', 'GeoController@searchState')->middleware('cache.headers:public,max-age=1800');
    Route::get('city/search', 'GeoController@searchCity')->middleware('cache.headers:public,max-age=1800');
});
